...
const SearchScreen = () => {
  ...
  const [checkboxState, setCheckboxState] = useState({
    reason: false,               //Контекст поиска
    mentions: false,             //Контекст поиска
    mainRole: false,             //Контекст поиска
    publicWithRisk: false,       //Контекст поиска
    INNOfCompany: "7728551528",  //Контекст поиска
    turnOnNews: false,              //Фильтр по атрибутам публикаций   
    turnOnCalendars: false,         //Фильтр по атрибутам публикаций
    turnOnReports: false,           //Фильтр по атрибутам публикаций
    countOfDocumentsInOut: 1000, //Количество возвращаемых публикаций
    searchRange: {                  //Период дат поиска
      start: "2015-01-04",                    //Период дат поиска
      end: "2024-04-04",                      //Период дат поиска
    },
    tonal: "Любая",
  ...
  const btnSearchToogle = //если "true" кнопка активна 
